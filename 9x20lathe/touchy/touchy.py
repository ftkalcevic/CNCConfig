...
themedir = "/home/frankt/linuxcnc/9x20lathe/touchy/theme"
try:
    import pygtk
    pygtk.require("2.0")
except:
...
class touchy:
    ...
    def periodic_radiobuttons(self):
        ...
        set_active(self.wTree.get_widget("mpgoff"), self.wheel == "mpgoff")
