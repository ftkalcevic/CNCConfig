...
# gcode import code taken from octoprint gcodeInterpreter.py, https://github.com/foosel/OctoPrint
# which is released under GNU AFFERO GENERAL PUBLIC LICENSE, Version 3, 19 November 2007
